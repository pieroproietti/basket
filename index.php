...
//Application Title
define('APP_TITLE', 'basket of eggs');
...
$auth_users = array(
    'artisan' => '$2y$10$7VmeVoy4.E5MKz.zvvFSyOhm6A6mJdKU6c0GlBSmVrjbGriya0pOC', //admin@123
    'guest' => '$2y$10$col6V8z7PBgy9YRPD1TvlOmGU2Cht4Hxl.GiwnaoraQz71Msb0zC.' // evolution
);
...
//$_SERVER['HTTP_HOST'].'/basket'
$http_host = 'penguins-eggs.net';
...
<?php
    ...
    function lng($txt)
    {
        ...
        $tr['en']['Login']          = 'Sign in';
        $tr['en']['Username']       = 'Username (guest)';
        $tr['en']['Password']       = 'Password (evolution)';
